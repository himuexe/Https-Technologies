...
export const Header = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 right-0 z-50 flex flex-row justify-between items-center px-20 py-5 text-center  ${scrolled? 'bg-black shadow-md' : 'bg-transparent'}`}>
      <span className="text-4xl  font-bold text-purple-500">
        Https Technologies
      </span>
      <div className="flex justify-between gap-8">
      <DropdownMenu>
        <DropdownMenuTrigger className="text-blue-500 text-lg hover:text-purple-600">Markets</DropdownMenuTrigger>
        <DropdownMenuContent>
      ...
      <DropdownMenu>
        <DropdownMenuTrigger className="text-blue-500 text-lg hover:text-purple-600">Products</DropdownMenuTrigger>
        <DropdownMenuContent>
      ...
      <span className="text-blue-500 text-lg hover:text-purple-600">Partner</span>
      <DropdownMenu>
        <DropdownMenuTrigger className="text-blue-500 text-lg hover:text-purple-600">Support</DropdownMenuTrigger>
        <DropdownMenuContent>
      ...
      <DropdownMenu>
        <DropdownMenuTrigger className="text-blue-500 text-lg hover:text-purple-600">News</DropdownMenuTrigger>
        <DropdownMenuContent>
      ...
      <DropdownMenu>
        <DropdownMenuTrigger className="text-blue-500 text-lg hover:text-purple-600">More</DropdownMenuTrigger>
        <DropdownMenuContent>
      ...
      <div className="flex justify-between gap-8 text-white font-semibold" >
